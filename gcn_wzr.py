...
class GCN(nn.Module):
    def __init__(self):
        ...
        self.fc0 = nn.Linear(256*2*2, 256)
...
#     new_check[k]=v
checkpoint = torch.load('./RAFDB/alexnetnewepoch169.pkl')
...
for epoch in range(100):
    ...
    for i in range(1524):
        ...
        outputs = vgg16(img)  #(16, 1024*10)
        print(img.shape)
        outputs = outputs.reshape(-1, 10, 1024)
    ...
    if (epoch+1) % 10 == 0 :
        ...
        torch.save(saved_dict, './RAFDB/gcn1alexepoch{}.pkl'.format(epoch))
